    ...
    >
      <div className="relative">
        ...
        {open && matches.length > 0 && (
          <ul className="animate-in fade-in slide-in-from-bottom-3 duration-200 absolute bottom-full right-0 mb-2 max-h-64 w-full overflow-y-auto rounded-lg border border-white/10 bg-[#070a14]/95 py-1 backdrop-blur-md">
            {matches.map((c, i) => (
              <li key={c.properties.iso2}>
                <button
                  ...
                  onClick={() => pick(c)}
                  className={`block w-full truncate px-3.5 py-1.5 text-left font-mono text-xs ${
                    i === highlight
